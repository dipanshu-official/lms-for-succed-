    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-lg border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          >
           <div>
            <img src="/logo.png" alt="Succeed House Logo" />
           </div>
            <div className="hidden sm:block">
              <h1 className="text-xl font-bold text-gray-900">Succeed House</h1>
          ...
          <div className="flex items-center space-x-3 relative group">
            ...
            <div className="w-8 h-8 rounded-full overflow-hidden bg-gradient-to-r from-accent-400 to-accent-600 flex items-center justify-center text-white text-sm font-semibold cursor-pointer">
              {user?.image ? (
                <img
                  src={user.image}
                  alt={user?.name || "User"}
